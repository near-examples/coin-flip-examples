...
[![](https://img.shields.io/github/workflow/status/near-examples/coin-flip-js/Tests/main?color=green&label=Tests)](https://github.com/near-examples/coin-flip-js/actions/workflows/tests.yml)
