...
const CoinGame = ({setLoading,setResult,result}) => {
    ...
    return (
        <div className="container mt-5">
            ...
            <div className="d-flex justify-content-center">
                <button className={`btn me-2 ${side=="heads" && result?color:"btn-primary"}`} onClick={() => handleChoice('heads')}>Heads</button>
                <button className={`btn ${side=="tails" && result?color:"btn-primary"}`} onClick={() => handleChoice('tails')}>Tails</button>
            </div>
